  ...
  <body>
    ...
    $faqs = [
     ...
     <div class="container">
       <nav>
         <div class="primo_nav">
           <a href="#"><img src="img/logo_google.png" alt=""> </a>
           <a href="#">Privacy e termini</a>
         </div>
         <div class="secondo_nav">
           <a href="#">Introduzione</a>
           <a href="#">Norme sulla privacy</a>
           <a href="#">Termini di servizio</a>
           <a href="#">Tecnologie</a>
           <a  class="selezionato" href="#">Domande frequenti</a>
           <a class="right m_r20" href="#">Account Google</a>
         </div>
       </nav>
       ...
       <div class="faqs">
         ...
         <div class="faq">
           <div class="domanda"> <?php echo $faq['domanda']; ?></div>
